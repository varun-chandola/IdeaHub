...
const YourLikedProjects = () => {
    const { allProjects, YourLikedProjects } = useContext(authContext)
    const navigate = useNavigate()
    useEffect(() => {
        YourLikedProjects()
    }, [])
    return (
        <div className='h-100vh flex justify-center mt-10'>
...
export default YourLikedProjects